...
class Destination(models.Model):
    ...
    price = models.IntegerField(max_length=255, help_text="Please Mention Currency")
    ...
    class Meta:
        verbose_name_plural = 'Products Package'
...
class Destination_Booking(models.Model):
    ...
    class Meta:
        verbose_name_plural = 'Product Customer Booking'
    ...
    def save(self, *args, **kwargs):
        ...
        if self.booking == "confirm":
            send_mail("Booking has been confirmed",
                      "Thank You for booking " + self.destination_name + ". Inventory", from_email,
